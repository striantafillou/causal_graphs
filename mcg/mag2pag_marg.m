function [pag, dnc, col, ddnc, dcol] =  mag2pag_marg(mag, isLatent)
% function PAG = MAG2PAG_MARG(MAG)
% Converts a MAG into a PAG over observed variables only
