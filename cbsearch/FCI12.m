function pag = FCI12(dataset, varargin)
...
[graph, sepSet, pag.pvalues, pag.maxSepSet, pag.nTests] = fciskeleton12(dataset, test, heuristic, alpha, maxK,  pdSep, verbose);
if verbose
