function [pag, sepSet,pvalues, maxSepSet, nTests] = fciskeleton12(dataset, test, heuristic, alpha, maxK,  pdSep, verbose)
% [pag, sepSet,pvalues, maxSepSet, nTests] = fciskeleton(dataset, test, alpha, maxK,  pdSep, verbose)
%Runs FCI skeleton with maxK  and alpha,adds edge 1-2
