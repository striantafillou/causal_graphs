function [cpdag, best_score] = learn_struct_ges_pk12(data, nodesizes, varargin)
%
% LEARN_STRUCT_GES learns a structure of Bayesian net by Greedy Equivalence
% Search with edge 1->2.
...
while ~done
    cptt=cptt+1;
    [pdags,nodes] = mk_nbrs_of_pdag_del_pk12(seeddag);
