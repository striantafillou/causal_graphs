...
public final class Pag implements TetradSerializable, Graph {
    ...
    public boolean isDefiniteNoncollider(Node node1, Node node2, Node node3) {
        return this.getGraph().isDefiniteNoncollider(node1, node2, node3);
    }

    public boolean isDefiniteCollider(Node node1, Node node2, Node node3) {
        return this.getGraph().isDefiniteCollider(node1, node2, node3);
    }
    ...
    public String toString() {
        ...
        for (Object underLineTriple : getUnderLineTriples()) {
            ulTrips += underLineTriple.toString() + "\n";
        }

        String dotUlTrips = "Dotted underline triples:  \n";

        for (Object dottedUnderLineTriple : getDottedUnderLineTriples()) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(new HashSet<Triple>(getUnderLineTriples()).equals(
                new HashSet<Triple>(pag.getUnderLineTriples())))) {
            return false;
        }

        if (!(new HashSet<Triple>(getDottedUnderLineTriples()).equals(
