...
//        BoxDataSet dataSet = new BoxDataSet(box, description.getVariables());
    ...
    public CovarianceMatrix parseCovariance(File file) throws IOException {
        FileReader reader = new FileReader(file);
        CovarianceMatrix covarianceMatrix = doCovariancePass(reader);
    ...
    public CovarianceMatrix parseCovariance(char[] chars) {
        ...
        reader.close();
        CharArrayReader reader2 = new CharArrayReader(chars);
        CovarianceMatrix covarianceMatrix = doCovariancePass(reader2);
...
//        LogUtils.getInstance().info("Max discrete = " + maxIntegralDiscrete);
    ...
    private void setValue(DataSet dataSet, int row, int col,
            String s) {
