...
/**
 * This is the same as the usual SepsetMap described below, but also keeps up
 * with the individual sets of conditioning nodes for d-separation relations
 * for use with the Distributed Causal Inference (DCI) algorithm.
 *
