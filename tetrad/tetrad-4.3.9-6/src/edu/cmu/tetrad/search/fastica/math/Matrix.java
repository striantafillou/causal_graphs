...
public class Matrix {
    ...
    /**
     * Converts a matrix object into a <code>String</code> object representing its
     * content.
     *
     ...
     * @return the resulting matrix
     */
    public static double[][] mult(double[][] mat1, double[][] mat2, boolean debug) {
//	if (debug)
//		System.out.println("mult: mat1 = " + FastIca.convertToColt(mat1) +
//			"     \nmat2 = " + FastIca.convertToColt(mat2));
        int m = mat1.length;
        int n = mat1[0].length;
        int o = mat2[0].length;
        double[][] matres = new double[m][];
        ...
        if (debug)
            System.out.println("mult: matres = " + matres);
        return (matres);
    }
    ...
    /**
     * Generates a matrix, whose diagonal contains the content of a given vector.
     * The remaining elements of the matrix contain zero.
     *
    ...
    public static double[][] square(
            double[][] mat) {
//	System.out.println("entered square: mat = " + FastIca.convertToColt(mat));
//	System.out.println("entered square: mat = " + FastIca.convertToColt(mat));
...
//		System.out.println("i = " + i + "   res[i][i] = " + res[i][i]);
...
//	System.out.println("square returning " + FastIca.convertToColt(res));
        return (res);
    }
