...
public interface EigenValueFilter {
    ...
    /**
     * This function is called after the data has been analysed using the Principal
     * Component Analysis.
     *
    ...
    /**
     * Returns the remaining eigenvectors, which were not excluded. The eigenvectors
     * must be stored in the columns of the matrix. Furthermore the first
     * eigenvector must belong to the first eigenvalue and so on.
     *
