...
public class FastICAConfig {
    ...
    /**
     * Creates a FastIca standard configuration:<br> - deflation approach<br> - step
     * size is one<br> - epsilon is 1.0e-12<br> - a maximum of 1000 iterations<br> -
    ...
    /**
     * Creates a FastIca standard configuration:<br> - one independent component<br>
     * - deflation approach<br> - step size is one<br> - epsilon is 1.0e-12<br> - a
     * maximum of 1000 iterations<br> - no initial mixing matrix<br>
     */
    public FastICAConfig() {
        this(1);
    }
