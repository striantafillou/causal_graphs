...
public class PCA {
    ...
    /**
     * This constructor computes the Principal Component Analysis of the given set
     * of vectors.
     *
...
//	System.out.println("PCA: covarianceMatrix = " + FastIca.convertToColt(covarianceMatrix));
