...
import edu.cmu.tetrad.search.indtest.ContinuousTetradTest;
import edu.cmu.tetrad.search.indtest.DiscreteTetradTest;
import edu.cmu.tetrad.search.indtest.IndependenceTest;
import edu.cmu.tetrad.search.indtest.TetradTest;
...
public class Purify {
    ...
    public Purify(DataSet dataSet, double sig, int testType,
                  Clusters clusters) {
    ...
    public static String[] getTestDescriptions() {
        ...
        testNames[3] = "Gaussian BIC (marks only)";
