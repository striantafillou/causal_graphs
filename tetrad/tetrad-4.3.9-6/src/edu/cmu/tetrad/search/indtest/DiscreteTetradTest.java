...
//                                                    this.rawdata[y][r], y)]++;
    ...
    public boolean oneFactorTest(int i, int j, int k, int l) {
        ...
        CovarianceMatrix covMatrix = new CovarianceMatrix(DataUtils.createContinuousVariables(vNames), new DenseDoubleMatrix2D(est.getEstimatedSem().getImplCovarMeas().toArray()),
                this.dataSet.getNumRows());
