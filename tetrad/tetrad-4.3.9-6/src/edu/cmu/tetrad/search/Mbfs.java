...
//        variables = graph.getNodes();
        ...
        logger.info("BEGINNING step 4 (PC Orient).");
        ...
        logger.info("BEGINNING step 5 (Trim graph to {T} U PC U " +
                "{Parents(Children(T))}).");
        ...
        logger.info("BEGINNING step 6 (Remove edges among P and P of C).");
...
//        System.out.println("***************NUMASSOC = " + numAssociated);
    ...
    private void prune(Node node, Graph graph, int depth) {
        logger.details("Trying to remove edges adjacent to node " + node +
                ", depth = " + depth + ".");
    ...
    private void finishUp(long start, Graph graph) {
        ...
        logger.info("MB fan search took " + nf.format(seconds) + " seconds.");
        logger.info("Number of independence tests performed = " +
...
//        }
    ...
    private void orientUnshieldedTriples(Knowledge knowledge, Graph graph,
        ...
        logger.info("Starting Collider Orientation:");
            ...
            while ((combination = cg.next()) != null) {
                ...
                if (type == TripleType.COLLIDER) {
                    if (colliderAllowed(x, y, z, knowledge)) {
                        ...
                        logger.colliderOriented(SearchLogUtils.colliderOrientedMsg(x, y, z));
                    }
        ...
        logger.info("Finishing Collider Orientation.");
    }
    ...
    private TripleType getTripleType(Graph graph, Node x, Node y, Node z,
        ...
        logger.details("Adjacents for " + x + "--" + y + "--" + z + " = " + _nodes);
    ...
    /**
     * Removes from adjx any adjacents that cannot be parents of x given the background
     * knowledge.
     *
